        ...
        <section className="min-h-screen w-full flex flex-col items-center justify-center text-center space-y-10 animate-in fade-in zoom-in-95 duration-1000 px-4 pt-48 pb-24">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="inline-flex flex-col sm:flex-row items-center gap-2 sm:gap-4 px-6 py-3 rounded-2xl bg-indigo-500/10 border border-indigo-500/30 text-center">
              <span className="text-indigo-200 text-xs font-black uppercase tracking-widest">🏷️ <span className="text-white">{t.landing_promo_price}</span></span>
