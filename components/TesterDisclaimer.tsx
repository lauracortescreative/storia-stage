      ...
      <div className="relative z-10 max-w-lg w-full bg-zinc-900/40 backdrop-blur-3xl border border-white/10 p-10 md:p-14 rounded-[4rem] text-center space-y-8 shadow-[0_0_100px_rgba(0,0,0,0.8)] animate-in fade-in zoom-in-95 duration-700 max-h-[95vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <h1 className="text-zinc-500 text-[10px] font-black uppercase tracking-[0.4em]">{t.tester_badge}</h1>
          ...
          <div className="space-y-4 text-zinc-400 text-sm md:text-base leading-relaxed font-medium">
            <p>
              This is an <span className="text-indigo-400 font-bold">{t.tester_desc}</span>
            </p>
          </div>
        </div>

        {/* Enter button — shown FIRST before social actions */}
        <button
          onClick={onProceed}
        ...
        {/* Instagram + Feedback — secondary actions below */}
        <div className="bg-indigo-600/10 p-5 rounded-3xl border border-indigo-500/20 text-xs w-full">
          <p className="text-indigo-300 font-bold mb-2">{t.tester_follow_title}</p>
          <p className="text-indigo-200/70 mb-4">
            {t.tester_follow_desc}
          </p>
