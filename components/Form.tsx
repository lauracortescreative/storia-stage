...
export const SUPPORTED_LANGUAGES = [
  ...
  "Italian", "German", "Polish", "Russian", "Bulgarian",
  "Dutch", "Turkish", "Arabic", "Japanese", "Korean",
  "Chinese (Simplified)", "Swedish", "Finnish"
];
...
export const RAW_REGION_DATA: Record<Region, { label: string; flag: string; lang: string; currency: string; themes: string[] }> = {
  ...
  bulgaria: { label: 'Bulgaria', flag: '🇧🇬', lang: 'Bulgarian', currency: 'лв', themes: ['theme_bulgaria_1', 'theme_bulgaria_2', 'theme_bulgaria_3', 'theme_bulgaria_4', 'theme_bulgaria_5', 'theme_bulgaria_6'] },
  ...
  china: { label: 'China', flag: '🇨🇳', lang: 'Chinese (Simplified)', currency: '¥', themes: ['theme_china_1', 'theme_china_2', 'theme_china_3', 'theme_china_4', 'theme_china_5', 'theme_china_6'] },
  egypt: { label: 'Egypt', flag: '🇪🇬', lang: 'Arabic', currency: 'E£', themes: ['theme_egypt_1', 'theme_egypt_2', 'theme_egypt_3', 'theme_egypt_4', 'theme_egypt_5', 'theme_egypt_6'] },
  finland: { label: 'Finland', flag: '🇫🇮', lang: 'Finnish', currency: '€', themes: ['theme_finland_1', 'theme_finland_2', 'theme_finland_3', 'theme_finland_4', 'theme_finland_5', 'theme_finland_6'] },
  ...
  germany: { label: 'Germany', flag: '🇩🇪', lang: 'German', currency: '€', themes: ['theme_germany_1', 'theme_germany_2', 'theme_germany_3', 'theme_germany_4', 'theme_germany_5', 'theme_germany_6'] },
  ...
  italy: { label: 'Italy', flag: '🇮🇹', lang: 'Italian', currency: '€', themes: ['theme_italy_1', 'theme_italy_2', 'theme_italy_3', 'theme_italy_4', 'theme_italy_5', 'theme_italy_6'] },
  japan: { label: 'Japan', flag: '🇯🇵', lang: 'Japanese', currency: '¥', themes: ['theme_japan_1', 'theme_japan_2', 'theme_japan_3', 'theme_japan_4', 'theme_japan_5', 'theme_japan_6'] },
  ...
  korea: { label: 'Korea', flag: '🇰🇷', lang: 'Korean', currency: '₩', themes: ['theme_korea_1', 'theme_korea_2', 'theme_korea_3', 'theme_korea_4', 'theme_korea_5', 'theme_korea_6'] },
  ...
  nordic: { label: 'Nordic', flag: '🌍', lang: 'Swedish', currency: 'kr', themes: ['theme_nordic_1', 'theme_nordic_2', 'theme_nordic_3', 'theme_nordic_4', 'theme_nordic_5', 'theme_nordic_6'] },
  ...
  netherlands: { label: 'Netherlands', flag: '🇳🇱', lang: 'Dutch', currency: '€', themes: ['theme_netherlands_1', 'theme_netherlands_2', 'theme_netherlands_3', 'theme_netherlands_4', 'theme_netherlands_5', 'theme_netherlands_6'] },
  turkey: { label: 'Turkey', flag: '🇹🇷', lang: 'Turkish', currency: '₺', themes: ['theme_turkey_1', 'theme_turkey_2', 'theme_turkey_3', 'theme_turkey_4', 'theme_turkey_5', 'theme_turkey_6'] },
  ...
  poland: { label: 'Poland', flag: '🇵🇱', lang: 'Polish', currency: 'zł', themes: ['theme_poland_1', 'theme_poland_2', 'theme_poland_3', 'theme_poland_4', 'theme_poland_5', 'theme_poland_6'] },
  ...
  russia: { label: 'Russia', flag: '🇷🇺', lang: 'Russian', currency: '₽', themes: ['theme_russia_1', 'theme_russia_2', 'theme_russia_3', 'theme_russia_4', 'theme_russia_5', 'theme_russia_6'] },
  sweden: { label: 'Sweden', flag: '🇸🇪', lang: 'Swedish', currency: 'kr', themes: ['theme_sweden_1', 'theme_sweden_2', 'theme_sweden_3', 'theme_sweden_4', 'theme_sweden_5', 'theme_sweden_6'] },
