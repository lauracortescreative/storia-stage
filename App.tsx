...
const ALL_TRANSLATIONS: Record<string, Partial<UITranslations>> = {
  'English': {
    ...
    account_cancelling: "Cancelling",
    account_status_active: "Active",
    account_ends: "Ends",
    account_upgrade_label: "Switch to Yearly & Save",
    account_yearly_price: "£59.99/year · best value",
    account_upgrade_btn: "Upgrade",
    account_billing_opening: "Opening…",
    account_billing_open_btn: "Open",
    account_prefills_form: "✨ Prefills form",
    account_open_library: "Open Library",
    account_redirecting: "Redirecting…",
